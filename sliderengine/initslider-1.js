jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"slice,threedflipwithzoom,threedwithzoom,threedflip,cssslide,threedtiles,slide,crossfade,kenburns,threedhorizontalwithzoom,fade,threedhorizontal,blinds,threed",
        scalemode:"fit",
        isfullscreen:false,
        textformat: {
